...
describe('Disclose', function () {
    ...
    describe('OFAC disclosure', function () {
        it('should allow disclosing OFAC check result when selector is 1', async function () {
            ...
            const revealedData_packed = await circuit.getOutput(w, ['revealedData_packed[4]']);
            console.log('revealedData_packed', revealedData_packed);
            const reveal_unpacked = formatAndUnpackReveal(revealedData_packed, 'id');

            console.log('reveal_unpacked', reveal_unpacked.join(''));
        ...
        //             data: genMockIdDoc({
        //                 idType: 'mock_id_card',
        //                 passportNumber: '98lh90556', // Matching passport number
        //             }),
        //             expectedBits: ['\x01', '\x01', '\x01'],
        //         },
        //         {
        ...
        //                 idType: 'mock_id_card',
        //                 passportNumber: 'DIF123456',
        //                 firstName: 'HENAO MONTOYA',
        //                 lastName: 'ARCANGEL DE JESUS',
        //                 birthDate: '541007',
        //                 expiryDate: '300101',
        //             }),
