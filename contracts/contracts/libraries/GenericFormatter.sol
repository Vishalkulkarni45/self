...
library GenericFormatter {
     ...
     */
    function fromV1Config(SelfStructs.VerificationConfigV1 memory verificationConfigV1)
        internal
        pure
        returns (SelfStructs.VerificationConfigV2 memory verificationConfig)
    {
     ...
     */
    function verificationConfigFromBytes(bytes memory verificationConfig)
        internal
        pure
     ...
     */
    function formatV1Config(SelfStructs.VerificationConfigV1 memory verificationConfigV1)
        internal
        pure
        returns (bytes memory v1ConfigBytes)
    {
     ...
     */
    function formatV2Config(SelfStructs.VerificationConfigV2 memory verificationConfigV2)
        internal
        pure
        returns (bytes memory v2ConfigBytes)
    {
        return abi.encode(verificationConfigV2);
    }
     ...
     */
    function toV2Struct(SelfStructs.GenericDiscloseOutputV2 memory genericDiscloseOutput)
        internal
        pure
        returns (bytes memory v2StructBytes)
    {
