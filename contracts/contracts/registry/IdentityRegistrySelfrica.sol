...
/**
 * @title IdentityRegistrySelfrica
 * @notice Acts as an upgradeable proxy for the Identity Registry Selfrica.
 ...
 */
contract IdentityRegistrySelfrica is ProxyRoot {
    /**
     * @notice Creates a new instance of the IdentityRegistrySelfrica proxy.
