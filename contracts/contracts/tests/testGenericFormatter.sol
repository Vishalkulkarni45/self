...
contract TestGenericFormatter {
    function testFromV1Config(SelfStructs.VerificationConfigV1 memory verificationConfigV1)
        public
        pure
    ...
    function testVerificationConfigFromBytes(bytes memory verificationConfig)
        public
        pure
        returns (SelfStructs.VerificationConfigV2 memory verificationConfigV2)
    {
    ...
    function testFormatV1Config(SelfStructs.VerificationConfigV1 memory verificationConfigV1)
        public
        pure
    ...
    function testFormatV2Config(SelfStructs.VerificationConfigV2 memory verificationConfigV2)
        public
        pure
    ...
    function testToV2Struct(SelfStructs.GenericDiscloseOutputV2 memory genericDiscloseOutput)
        public
        pure
