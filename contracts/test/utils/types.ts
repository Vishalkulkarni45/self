...
// Type definitions
export type VcAndDiscloseVerifier = typeof process.env.TEST_ENV extends "local"
  ? LocalVerifier
  : ProdVerifier;
export type RegisterVerifier = typeof process.env.TEST_ENV extends "local"
  ? LocalRegisterVerifier
  : ProdRegisterVerifier;
export type DscVerifier = typeof process.env.TEST_ENV extends "local"
  ? LocalDscVerifier
  : ProdDscVerifier;
